...
public final class AssetTransfer implements ContractInterface {
    ...
    /**
     * Duplicates a new asset on the ledger.
     *
     * @param ctx     the transaction context
     * @param assetID the ID of the duplicated asset
     * @param owner   the owner of the duplicated asset
     * @return new asset which is duplicated
     */
    @Transaction(intent = Transaction.TYPE.SUBMIT)
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String owner) {
        ...
        String duplicateAssetID = assetID + "_dup";

        if (AssetExists(ctx, duplicateAssetID)) {
            String errorMessage = String.format("Asset %s already exists which is the duplicate of %s",
